const contentLetterSrart_actived = "Hôm nay có phải là sinh nhật của vợ tương lai (Thu Hằng) phải không nhỉ?" //Lời mở đầu cho bức thư
const mainContentLetter = "Tin nhắn này không có chất béo, không cholesterol và không chứa chất gây nghiện, nó chỉ có rất nhiều đường mà thôi. Nhưng dù nhiều đường thế nào đi chăng nữa nó cũng không bao giờ có thể ngọt ngào như em - người đang đọc nó. Chúc em sinh nhật hạnh phúc và tràn đầy tiếng cười nha!" //Nội dung của bức thư
